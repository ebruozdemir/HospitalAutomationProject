            ...
            <div  style="padding-top:100px;">
                <table>
                    <tr style="background-color:rgb(120, 154, 255);">
                        <th style="padding:15px;  font-size:20px;  color:white;">Patient Name</th>
                        <th style="padding:15px;  font-size:20px;  color:white;">Email</th>
                        <th style="padding:15px;  font-size:20px;  color:white;">Phone</th>
                        <th style="padding:15px;  font-size:20px;  color:white;">Doctor Speciality</th>
                ...
                @foreach($data as $appoint)
                    <tr align="center" style="background-color:white;">
                       ...
                       <td style="color:black;">{{$appoint->speciality}}</td> 
