...
<div align="center" style="padding:70px;">
   ...
   <table>
     ...
     <tr style="background-color:rgb(179, 205, 255);">
        ...
        <th style="padding:15px; font-size:25px; color:white;">Announcement Title</th>
        <th style="padding:15px; font-size:25px; color:white;">Content</th>
       
     @foreach($data as $announcement)

     <tr style="background-color:white" align="center">
         <td style="padding:15px; font-size:25px; color:black;">{{$announcement->created_at}}</td>
        <td style="padding:15px; font-size:25px; color:black;">{{$announcement->title}}</td>
        <td style="padding:15px; font-size:25px; color:black;">{{$announcement->message}}</td>
